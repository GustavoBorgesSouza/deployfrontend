...
export const Equipamentos = () => {
    ...
    const Cadastrar = (event) => {
      ...
      axios({
        method: "post",
        url: "http://apiosasco.azurewebsites.net/api/Equipamentos",
        data: formData,
    ...
    const Listar = () => {
      axios.get('http://apiosasco.azurewebsites.net/api/Equipamentos')
      .then(resposta => {
    ...
    const Remover = (id) => {
      axios.delete('http://apiosasco.azurewebsites.net/api/Equipamentos/'+id)
      .then(() => {
        Listar();
      })
      .catch(erro => console.log(erro))
